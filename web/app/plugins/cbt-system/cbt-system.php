...
add_action('init', function() {
    ...
    register_post_type('cbt_exam' , [
        'labels' => [
            'name'  => 'Exams',
            'singular_name' => 'Exam',
            'add_new'   => 'Tambah Ujian',
            'add_new_item' => 'Tambah Ujian Baru',   
            'edit_item'     =>'Edit Ujian',
            'new_item'      => 'Ujian Baru',
            'view_item'     => 'Lihat Ujian',
            'search_items' => 'Cari Ujian',
            'not_found' => 'Tidak ada ujian ditemukan',
            'not_found_in_trash'    => 'Tidak ada ujian ditemukan di sampah',
            'menu_name' => 'Kelola Ujian',
        ],
        'public'    =>false,
